...
provider "google-beta" {
  ...
  billing_project       = "cs-host-a11d4d9a52ce4fceadb4c1"
}
...
module "cs-gg-prod1-service" {
  ...
  id           = "prod1-service@juliettechocharlie.com"
...
module "cs-gg-prod2-service" {
  ...
  id           = "prod2-service@juliettechocharlie.com"
...
module "cs-gg-nonprod1-service" {
  ...
  id           = "nonprod1-service@juliettechocharlie.com"
...
module "cs-gg-nonprod2-service" {
  ...
  id           = "nonprod2-service@juliettechocharlie.com"
